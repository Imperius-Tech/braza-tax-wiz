...
const features = [
  { icon: TrendingDown, label: "Reducao de Impostos" },
          ...
          <>
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-5">
                ...
                Assistente Tributario Inteligente
              </div>
              ...
              <p className="text-muted-foreground max-w-lg mx-auto">
                Descubra quanto sua empresa pode economizar em impostos com estrategias 100% legais.
              </p>
            ...
            <p className="text-center text-xs text-muted-foreground mt-8">
              As estrategias sao sugestoes baseadas em inteligencia artificial e nao substituem consultoria tributaria profissional.
            </p>
          </>
        )}
